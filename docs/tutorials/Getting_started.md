...
The files are located in the [Comic-database-service GitHub repository](https://github.com/KusumaKrish15/Comic-Book.DB) on GitHub. The directory contains the following files:
